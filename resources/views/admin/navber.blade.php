<nav class="navbar navbar-expand-lg">
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <div class="right-menu list-inline no-margin-bottom">
            <div class="list-inline-item"><a href="admin/#" class="search-open nav-link"><i
                        class="icon-magnifying-glass-browser"></i></a></div>
            <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="admin/http://example.com"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1">5</span></a>
                <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="admin/#"
                    ...
                    </a><a href="admin/#" class="dropdown-item message d-flex align-items-center">
                    ...
                    </a><a href="admin/#" class="dropdown-item text-center message"> <strong>See All Messages <i
                                class="fa fa-angle-right"></i></strong></a></div>
            </div>
            <!-- Tasks-->
            <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink2" href="admin/http://example.com"
                ...
                <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list"><a href="admin/#"
                        class="dropdown-item">
                    ...
                    </a><a href="admin/#" class="dropdown-item">
                    ...
                    </a><a href="admin/#" class="dropdown-item text-center"> <strong>See All Tasks <i
                                class="fa fa-angle-right"></i></strong></a>
                </div>
            </div>
            <!-- Tasks end-->
            <!-- Megamenu-->
            <div class="list-inline-item dropdown menu-large"><a href="admin/#" data-toggle="dropdown"
                ...
                <div class="dropdown-menu megamenu">
                    <div class="row">
                        <div class="col-lg-3 col-md-6"><strong class="text-uppercase">Elements Heading</strong>
                            <ul class="list-unstyled mb-3">
                                <li><a href="admin/#">Lorem ipsum dolor</a></li>
                                <li><a href="admin/#">Sed ut perspiciatis</a></li>
                                <li><a href="admin/#">Voluptatum deleniti</a></li>
                                <li><a href="admin/#">At vero eos</a></li>
                                <li><a href="admin/#">Consectetur adipiscing</a></li>
                                <li><a href="admin/#">Duis aute irure</a></li>
                                <li><a href="admin/#">Necessitatibus saepe</a></li>
                                <li><a href="admin/#">Maiores alias</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-6"><strong class="text-uppercase">Elements Heading</strong>
                            <ul class="list-unstyled mb-3">
                    ...
                    <div class="row megamenu-buttons text-center">
                        <div class="col-lg-2 col-md-4"><a href="admin/#"
                        ...
                        <div class="col-lg-2 col-md-4"><a href="admin/#"
                                class="d-block megamenu-button-link bg-danger"><i class="fa fa-clock-o"></i><strong>Demo
                                    5</strong></a></div>
                        <div class="col-lg-2 col-md-4"><a href="admin/#" class="d-block megamenu-button-link bg-info"><i
